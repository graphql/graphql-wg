...
1. Find information about our [set of meetings][] in the repo Readme.
2. Subscribe to our [calendar][] to see upcoming meetings.
3. Find an upcoming [agenda file][] in the `agendas/` directory.
