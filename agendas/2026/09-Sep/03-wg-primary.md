...
# GraphQL WG — September 2026 (Primary)
...
- **Date & Time**: [September 3, 2026, 10:30 AM – 12:00 PM PDT](https://www.timeanddate.com/worldclock/converter.html?iso=20260903T173000&p1=224&p2=179&p3=136&p4=268&p5=367&p6=438&p7=248&p8=240)
...
1. Review prior secondary meetings (5m, Host)
   - [GraphQL WG — August 2026 (Secondary, EU)](https://github.com/graphql/graphql-wg/blob/main/agendas/2026/08-Aug/20-wg-secondary-eu.md)
1. Check for [ready for review agenda items](https://github.com/graphql/graphql-wg/issues?q=is%3Aissue+is%3Aopen+label%3A%22Ready+for+review+%F0%9F%99%8C%22+sort%3Aupdated-desc) (5m, Host)
1. **Spec release**: spec release is live! (pending 45 day notice period) (5m, Host)
1. Reminder: [grants available for key initiatives](https://graphql.org/community/foundation/community-grant/) (1m, Host)
1. James Bellenger: `@oneOf` inhabitability
...
1. Allow empty selection sets
   ...
   - Aim: discussion (we need implementation in graphql-js)
