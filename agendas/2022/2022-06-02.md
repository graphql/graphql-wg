...
1. `@oneOf` update (15m, Benjie Gillam)
...
1. "Unions implementing interface" update (10m, Yaacov Rydzinski)
   - Edge case with querying fields directly on interface (link: https://github.com/graphql/graphql-spec/pull/939#issuecomment-1139267078)
