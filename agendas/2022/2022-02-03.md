...
# GraphQL WG – February 2022

The GraphQL Working Group meets monthly to discuss proposed additions to the
[GraphQL Specification][] and other relevant topics to core GraphQL projects.
This is an open meeting in which anyone in the GraphQL community may attend.

- **Date & Time**: [February 3rd 2022 19:00 - 21:00 UTC](https://www.timeanddate.com/worldclock/meetingdetails.html?year=2022&month=2&day=3&hour=19&min=0&sec=0&p1=224&p2=179&p3=136&p4=268&p5=367&p6=438&p7=240&iv=0)
...
- **Video Conference Link**: https://zoom.us/j/593263740
  - *Password:* graphqlwg
- **Live Notes**: [Google Doc](https://docs.google.com/document/d/1HLqCrgd_1iSTmv7WRwhPm9qFC9cEiwHq3voMKdwxOrc/edit?usp=sharing)
...
| Roman Ivantsov     | @rivantsov      | Microsoft          | Seattle, WA, USA
| Saihajpreet Singh  | @saihaj         | The Guild          | Ottawa, ON, CA
| Alex Reilly        | @twof           | Yelp               | San Francisco, CA, US
| Oleg Kovalov       | @cristaloleg    | Individual         | Warsaw, PL
...
| Sasha Solomon      | @sachee         | Twitter            | Portland, OR
...
1. Deprecation of Inputs => Stage 3 (5m, Stephen)
...
1. Allowing recursive references in fragments. 
