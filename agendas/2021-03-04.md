...
1. Directives via Introspection support (https://github.com/graphql/graphql-spec/issues/300) (15 min,Andi) 
1. Allow fields to diverge more (https://github.com/graphql/graphql-spec/issues/820)(15 min, Andi)
2. Alternate WG meeting times (https://github.com/graphql/graphql-wg/issues/590) (15 min, Andi)
3. RFC: Oneof Input Objects and Oneof Fields (30m, Benjie)
   - [RFC PR](https://github.com/graphql/graphql-spec/pull/825)
4. *ADD YOUR AGENDA ABOVE*
